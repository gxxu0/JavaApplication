...
<html lang="ko">
  ...
  <body>
    ...
    <a href="./mypostlist.jsp">
      ...
      <a href="./likepostlist.jsp">
        ...
        <a href="./unsign_check.jsp">
          <div class="side-bar-my-write" style="color: black">회원 탈퇴</div>
          </a>
          </aside>
    <main class="user">
        <div>
    ...
    <div class="sign">
        <form action="./unsign.jsp" onsubmit="return sendit();" method="post" name="fr">
          <div class="pw">
                <input type="password" name="pw_check" placeholder="  비밀번호를 입력해주세요"/></div>
            <div class="submit">
                <input type="submit" id="sign-submit" value="탈퇴하기" onclick="check()">
            </div>
        </form>
