...
<body>
  ...
  <a href="./mypostlist.jsp">
    ...
    <a href="./likepostlist.jsp">
      <div class="side-bar-my-write" style="color: black">내가 찜한 게시글</div>
      </a>
      <a href="./delete_revise.jsp">
        ...
        String sql = "SELECT * FROM board JOIN likepost ON board.Bno =likepost.Lno AND likepost.lid = '"+user_id+"'"; 
