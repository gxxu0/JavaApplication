                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header justify-content-center text-center text-black fw-600">닉네임 중복 확인 결과</div>
                                <div class="card-body">
                                    <div class="mb-3">
                                        입력 닉네임  : <span class="fw-700 text-lg" name="nick"><% out.println(nick);%></span>
                                    </div>
                                    <%
                                        if (cnt == 0) {
                                            out.println("사용 가능한 닉네임입니다.");
                                            out.println("<span><a href='javascript:apply(\"" + nick + "\")'><button class='btn btn-primary' style='float: right'>적용</button></a></span>");
                                    %> 
                                    <%
                                        } else {
